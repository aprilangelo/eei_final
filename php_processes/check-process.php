...
$query = "UPDATE user_access_ticket_t SET isChecked = 1 WHERE ticket_id = $ticketID";
...
$query5 = "SELECT CONCAT(first_name, ' ', last_name) as name FROM user_t u left join user_access_ticket_t t on u.user_id = t.approver WHERE t.ticket_id = '$ticketID'";
...
$notifSql = "INSERT INTO notification_t (notification_id,ticket_id, user_id, notification_description, isRead, timestamp) VALUES(DEFAULT, $ticketID,$row[approver],'New ticket $ticketNo for approval',0, now())";
